...
public class EditContactLocationSelectionAddress extends FragmentActivity implements OnMapReadyCallback,
    ...
    private EditContactLocationSelectionAddress ADD_PICK_DROP_CONTEXT;
...
//        getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_HIDDEN);
        ...
        list = getIntent().getStringArrayListExtra("list_spine");
        list2 = getIntent().getStringArrayListExtra("contact_list");
        list_id = getIntent().getStringArrayListExtra("listid");
        ...
        sessionManagerAddress = new AddressSavedSharedPreferences(EditContactLocationSelectionAddress.this);
       ...
       /* save_BTN.setOnClickListener(new OnClickListener() {
        ...
        tick.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EditContactLocationSelectionAddress.this, EditContact.class);
                intent.putExtra("Location", address_ET.getText().toString());
        ...
        back.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                in.hideSoftInputFromWindow(address_ET.getWindowToken(), 0);
                EditContactLocationSelectionAddress.this.finish();
            }
        });
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ActivityCompat.requestPermissions(EditContactLocationSelectionAddress.this,
