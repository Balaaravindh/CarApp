...
public class SearchListAdapter extends ArrayAdapter<SingleProductModel> {
    ...
    List<SingleProductModel> car_list;
    ...
    public SearchListAdapter(Context context, ArrayList<SingleProductModel> car_list, ArrayList<String> arrayList, ArrayList<String> alert, ArrayList<String> compare) {
        super(context, R.layout.search_list_single_item, car_list);
       ...
       /* Animation animation = AnimationUtils.loadAnimation(getContext(), (position > lastPosition) ? R.anim.up_from_bottom : R.anim.down_from_top);
        ...
        holder.like_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                pos = car_list.get(position).getCar_id();
                String name = car_list.get(position).getMake();
                Log.e("car_name", name);
                if (storyId.equals("0")) {
        ...
        holder.alert_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                pos_alert = car_list.get(position).getCar_id();
                String name = car_list.get(position).getMake();
                Log.e("car_name", name);
        ...
        holder.compare_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.e("new_compare",new_compare.get(position).toString());
                ...
                pos_compare = car_list.get(position).getCar_id();
                String name = car_list.get(position).getMake();
                Log.e("car_name", name);
