...
import com.falconnect.dealermanagementsystem.Adapter.PopularCityNewAdapter;
...
//        getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_HIDDEN);
        ...
        popular_city_recycleview.setLayoutManager(new LinearLayoutManager(CityResultActivity.this, LinearLayoutManager.HORIZONTAL, false));
        ...
        adapter = new PopularCityNewAdapter(CityResultActivity.this, data);
        popular_city_recycleview.setAdapter(adapter);
        back_close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CityResultActivity.this, DashBoard.class);
                startActivity(intent);
                CityResultActivity.this.finish();
            }
        });
    ...
    public void onBackPressed() {
        Toast.makeText(CityResultActivity.this, "Please select any one city", Toast.LENGTH_SHORT).show();
    }
    ...
    private class City_Datas extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            ////City Data Get
            listAdapter = new ArrayAdapter<String>(CityResultActivity.this, R.layout.search_list_view_single_item, R.id.text1, spinner_datas);
            ...
            searchlistview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Intent intent = new Intent(CityResultActivity.this, SearchResultActivity.class);
            ...
            searcheditlist.addTextChangedListener(new TextWatcher() {
                ...
                public void onTextChanged(CharSequence s, int start, int before, int count) {
                    CityResultActivity.this.listAdapter.getFilter().filter(s);
                }
