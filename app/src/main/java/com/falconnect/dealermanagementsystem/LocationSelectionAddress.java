...
public class LocationSelectionAddress extends FragmentActivity implements OnMapReadyCallback,
    ...
    private LocationSelectionAddress ADD_PICK_DROP_CONTEXT;
...
//        getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_HIDDEN);
        ...
        sessionManagerAddress = new AddressSavedSharedPreferences(LocationSelectionAddress.this);
       ...
       /* save_BTN.setOnClickListener(new OnClickListener() {
        ...
        tick.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(LocationSelectionAddress.this, ManageDashBoardActivity.class);
        ...
        back.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LocationSelectionAddress.this.finish();
            }
        });
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ActivityCompat.requestPermissions(LocationSelectionAddress.this,
